# [atm9sky-1.0.8a](https://www.curseforge.com/minecraft/modpacks/all-the-mods-9-to-the-sky) on Curseforge
...
The docker on first run will download the same version as tagged of `atm9sky-1.0.8a` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "atm9sky-1.0.8a Server Powered by Docker"
* LEVEL world
